interface SubjectsInsightBarProps {
  message: string;
}

export function SubjectsInsightBar({ message }: SubjectsInsightBarProps) {
  return (
    <div
      className="mb-4 flex items-center gap-3 rounded-lg px-4 py-[11px]"
      style={{
        background: "rgba(34,211,238,0.04)",
        border: "1px solid rgba(34,211,238,0.1)",
      }}
      role="status"
      aria-label="JARVIS curriculum insight"
    >
